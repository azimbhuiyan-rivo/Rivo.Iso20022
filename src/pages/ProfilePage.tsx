      ...
      <div className={!editing ? "readonlyPanel" : ""}>
        <div className="row">
          <div className="col">
            ...
            <label>Länsförsäkringar Företagsförsäkring BG</label>
            <input disabled={!editing} value={draft.lansForetagBg} onChange={(e) => set("lansForetagBg", onlyDigits(e.target.value))} />
